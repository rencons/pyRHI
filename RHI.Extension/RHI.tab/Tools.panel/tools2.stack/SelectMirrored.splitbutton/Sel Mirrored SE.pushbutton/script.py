...
__doc__ = "Selects All Speciality Equipment Instances that have been Mirrored."
__author__ = '@gtalarico'
__title__ = "Select Mirrored\nSpeciality Equipment"

from rpw import db, ui

windows = db.Collector(of_category='OST_SpecialityEquipment').get_elements(wrapped=True)
...
ui.forms.Alert(msg, title="Mirrored Speciality Equipment")
